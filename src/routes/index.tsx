...
const specialties = [
  ...
  { icon: Sparkles, title: "Projeto de Vida", desc: "Desenvolvimento de uma aplicação em parceria com Portugal desde 2024. Focado em escalabilidade e tecnologias modernas, o projeto une engenharia de software e colaboração remota para criar soluções digitais de alto impacto." },
      ...
      <div className="mx-auto w-[min(1200px,94%)]">
        <div className="grid items-center gap-12 md:grid-cols-[1fr_1.2fr]">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                href="https://www.instagram.com/_natanael.rc/"
                target="_blank"
              ...
              <a
                href="https://wa.me/5561991816548"
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-xl border border-[#25D366]/40 bg-[#25D366]/10 px-5 py-3 text-sm font-semibold text-[#25D366] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#25D366]/20 hover:border-[#25D366]/60 hover:shadow-[0_8px_30px_-8px_rgba(37,211,102,0.35)]"
              >
    ...
    <footer className="border-t border-border py-10">
      <div className="mx-auto flex w-[min(1200px,94%)] flex-col items-center justify-between gap-4 text-sm text-muted-foreground md:flex-row">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://www.instagram.com/_natanael.rc/" target="_blank" rel="noopener noreferrer" className="grid h-9 w-9 place-items-center rounded-lg border border-border transition-colors hover:bg-secondary hover:text-foreground" aria-label="Instagram">
            <Instagram className="h-4 w-4" />
          </a>
